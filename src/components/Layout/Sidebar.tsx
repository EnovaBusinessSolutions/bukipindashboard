...
const Sidebar = () => {
  ...
  const cobrosPagosItems = [
    ...
    { name: "Base de Datos Clientes", path: "/clientes", active: location.pathname === "/clientes" },
  ];
  ...
  return (
    <div className="bg-sidebar h-screen w-64 flex flex-col">
      ...
      <div className="px-3 py-4">
        <Collapsible 
          open={openSections.contabilidad} 
          onOpenChange={() => toggleSection('contabilidad')}
        >
      ...
      <div className="px-3 py-4">
        <Collapsible 
          ...
          onOpenChange={() => toggleSection('registros')}
        >
          <CollapsibleTrigger asChild>
            <Button
              variant="ghost"
      ...
      <div className="px-3 py-4 flex-1">
        <Collapsible 
          open={openSections.estadosFinancieros} 
          onOpenChange={() => toggleSection('estadosFinancieros')}
        >
          <CollapsibleTrigger asChild>
            <Button
              variant="ghost"
            ...
            >
              ...
              {openSections.estadosFinancieros ? 
                <ChevronDown className="h-4 w-4" /> : 
                <ChevronRight className="h-4 w-4" />
              }
            </Button>
