...
import { Package, ClipboardList, BarChart3, FileText } from "lucide-react";
...
import ResumenTransaccionesInventario from "@/components/Inventario/ResumenTransaccionesInventario";
    ...
    <div className="h-full overflow-hidden flex flex-col">
      ...
      <div className="flex-1 overflow-auto p-6">
        <Tabs defaultValue="registro" className="h-full">
          ...
          <TabsContent value="transacciones" className="h-full">
            <ResumenTransaccionesInventario />
          </TabsContent>
