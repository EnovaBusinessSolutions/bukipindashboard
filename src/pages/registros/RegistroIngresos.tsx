      ...
      <div className="space-y-4">
        ...
        <RadioGroup value={selectedIncomeType} onValueChange={setSelectedIncomeType}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Precargados */}
            <div className="relative border rounded-xl hover:bg-muted/50 transition">
              ...
              <Label
                htmlFor="precargados"
                className="cursor-pointer flex flex-col items-center justify-center text-center p-8 min-h-[180px]"
              >
