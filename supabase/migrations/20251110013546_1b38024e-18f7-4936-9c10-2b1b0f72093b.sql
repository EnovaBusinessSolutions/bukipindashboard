-- FASE 2: Agregar campos a la tabla inversiones_capex para manejo de ventas
ALTER TABLE inversiones_capex 
ADD COLUMN IF NOT EXISTS metodo_pago_venta TEXT,
ADD COLUMN IF NOT EXISTS tipo_pago_venta TEXT,
ADD COLUMN IF NOT EXISTS monto_pagado_venta NUMERIC DEFAULT 0,
ADD COLUMN IF NOT EXISTS monto_pendiente_venta NUMERIC DEFAULT 0,
ADD COLUMN IF NOT EXISTS fecha_vencimiento_venta DATE,
ADD COLUMN IF NOT EXISTS comprador_nombre TEXT,
ADD COLUMN IF NOT EXISTS comprador_rfc TEXT,
ADD COLUMN IF NOT EXISTS comprador_telefono TEXT,
ADD COLUMN IF NOT EXISTS comprador_email TEXT;

-- FASE 3 y 4: Actualizar trigger para manejo correcto de ventas con diferentes métodos de pago
